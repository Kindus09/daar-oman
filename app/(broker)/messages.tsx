...
export default function BrokerMessagesScreen() {
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <View style={styles.threadInfo}>
              <Text style={styles.threadName} numberOfLines={1}>{item.requesterName}</Text>
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyText}>
              Send offers to start chatting with clients
            </Text>
          </View>
        }
      />
